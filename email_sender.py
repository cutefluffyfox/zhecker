...
email_types = {
    'verification': f'<h1>Welcome to our testing system Zhecker!</h1><p>You are at the last stage to start solving problems. To confirm your email, click on<b><a href="{environ["HOST_FULLNAME"]}/email_verification?action_type=submit&email=%email%&verification_key=%verification_key%"><div style="color:rgb(160, 210, 160);">this link</div></a></b></p><p>If you do not confirm it within an hour, you will have to register again. If you have inadvertently received this email, click<b><a href="{environ["HOST_FULLNAME"]}/email_verification?action_type=remove&email=%email%&verification_key=%verification_key%"><div style="color:rgb(210, 160, 160);">right here</div></a></b></p>',
    'verification_plain': f'Welcome to our testing system Zhecker!\n\nYou are at the last stage to start solving problems. To confirm your email, click on this link: {environ["HOST_FULLNAME"]}/email_verification?action_type=submit&email=%email%&verification_key=%verification_key%\n\nIf you do not confirm it within an hour, you will have to register again. If you have inadvertently received this email, click right here: {environ["HOST_FULLNAME"]}/email_verification?action_type=remove&email=%email%&verification_key=%verification_key%',
    ...
    'get_creator': f'<h1>Hello!</h1><p>One more user want to become a creator. Here what they say:</p><p style="text-align: center;"><em>%message%</em></p><p style="text-align: left;">To confirm their new status click&nbsp;<span style="color: #008000;"><a style="color: #008000;" href="{environ["HOST_FULLNAME"]}/creator_confirmation?action_type=submit&user_id=%user_id%&confirmation_key=%confirmation_key%">right here</a></span></p><p style="text-align: left;">If something wrong, please click&nbsp;<span style="color: #993300;"><a style="color: #993300;" href="{environ["HOST_FULLNAME"]}/creator_confirmation?action_type=deny&user_id=%user_id%&confirmation_key=%confirmation_key%">here</a></span></p>',
    'get_creator_plain': f'Hello!\n\nOne more user want to become a creator. Here what they say:\n\n%message%\n\nTo confirm their new status click right here:\n\n {environ["HOST_FULLNAME"]}/creator_confirmation?action_type=submit&user_id=%user_id%&confirmation_key=%confirmation_key%\n\nIf something wrong, please click here: \n\n{environ["HOST_FULLNAME"]}/creator_confirmation?action_type=deny&user_id=%user_id%&confirmation_key=%confirmation_key%',
